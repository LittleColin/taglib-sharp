...
namespace TagLib.Riff
{
    ...
    public struct BitmapInfoHeader : IVideoCodec
    {
        ...
        /// </summary>
        private readonly ByteVector _compressionId;
        ...
        /// </summary>
        private readonly uint _xPixelsPerMeter;

        /// <summary>
        ///    Contains the number of Y pixels per meter.
        /// </summary>
        private readonly uint _yPixelsPerMeter;
        ...
        public BitmapInfoHeader(ByteVector data, int offset)
        {
            ...
            _size = data.Mid(offset + 0, 4).ToUInt(false);
            _width = data.Mid(offset + 4, 4).ToUInt(false);
            _height = data.Mid(offset + 8, 4).ToUInt(false);
            _planes = data.Mid(offset + 12, 2).ToUShort(false);
            _bitCount = data.Mid(offset + 14, 2).ToUShort(false);
            _compressionId = data.Mid(offset + 16, 4);
            _sizeOfImage = data.Mid(offset + 20, 4).ToUInt(false);
            _xPixelsPerMeter = data.Mid(offset + 24, 4).ToUInt(false);
            _yPixelsPerMeter = data.Mid(offset + 28, 4).ToUInt(false);
            _colorsUsed = data.Mid(offset + 32, 4).ToUInt(false);
            _colorsImportant = data.Mid(offset + 36, 4).ToUInt(false);
        }
        ...
        ///    image.
        /// </value>
        public ByteVector CompressionId => _compressionId;
        ...
        ///    bytes in the image.
        /// </value>
        public uint ImageSize => _sizeOfImage;
        ...
        ///    target device.
        /// </value>
        public uint XPixelsPerMeter => _xPixelsPerMeter;
        ...
        ///    target device.
        /// </value>
        public uint YPixelsPerMeter => _yPixelsPerMeter;
        ...
        ///    colors.
        /// </value>
        public uint ColorsUsed => _colorsUsed;
        ...
        ///    important colors.
        /// </value>
        public uint ImportantColors => _colorsImportant;
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                return (int)(_size ^ _width ^ _height ^ _planes ^
                    _bitCount ^ _compressionId.ToUInt() ^
                    _sizeOfImage ^ _xPixelsPerMeter ^
                    _yPixelsPerMeter ^ _colorsUsed ^
                    _colorsImportant);
            }
        }
        ...
        {
            return _size == other._size && _width == other._width &&
                _height == other._height && _planes == other._planes &&
                _bitCount == other._bitCount &&
                _compressionId == other._compressionId &&
                _sizeOfImage == other._sizeOfImage &&
                _xPixelsPerMeter == other._xPixelsPerMeter &&
                _yPixelsPerMeter == other._yPixelsPerMeter &&
                _colorsUsed == other._colorsUsed &&
                _colorsImportant == other._colorsImportant;
        }

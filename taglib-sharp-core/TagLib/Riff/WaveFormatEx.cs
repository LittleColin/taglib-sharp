...
namespace TagLib.Riff
{
    ...
    public struct WaveFormatEx : IAudioCodec, ILosslessAudioCodec
    {
        ...
        /// </summary>
        private readonly uint _samplesPerSecond;
        ...
        public WaveFormatEx(ByteVector data, int offset)
        {
            ...
            _formatTag = data.Mid(offset, 2).ToUShort(false);
            _channels = data.Mid(offset + 2, 2).ToUShort(false);
            _samplesPerSecond = data.Mid(offset + 4, 4)
                .ToUInt(false);
            _averageBytesPerSecond = data.Mid(offset + 8, 4)
                .ToUInt(false);
            _bitsPerSample = data.Mid(offset + 14, 2)
                .ToUShort(false);
        }
        ...
        ///    />.
        /// </remarks>
        public ushort FormatTag => _formatTag;
        ...
        int ILosslessAudioCodec.BitsPerSample => _bitsPerSample;
        ...
        public int AudioBitrate => (int)Math.Round(
            _averageBytesPerSecond * 8d / 1000d);
        ...
        /// </value>
        public int AudioSampleRate => (int)_samplesPerSecond;
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                return (int)(_formatTag ^ _channels ^
                    _samplesPerSecond ^
        ...
        {
            return _formatTag == other._formatTag &&
                _channels == other._channels &&
                _samplesPerSecond == other._samplesPerSecond &&
                _averageBytesPerSecond == other._averageBytesPerSecond &&

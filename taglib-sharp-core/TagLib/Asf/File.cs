...
namespace TagLib.Asf
{
    ...
    public class File : TagLib.File
    {
        ...
        /// </value>
        public override TagLib.Tag Tag => _asfTag;
            ...
            try
            {
                ...
                else
                {
                    ...
                    header.AddUniqueObject(
                        _asfTag.ContentDescriptionObject);
                    header.AddUniqueObject(
                        _asfTag.ExtendedContentDescriptionObject);
                    header.Extension.AddUniqueObject(
                        _asfTag.MetadataLibraryObject);
                }

...
namespace TagLib.Asf
{
    ...
    public class Tag : TagLib.Tag, IEnumerable<ContentDescriptor>
    {
        ...
        /// </summary>
        private readonly MetadataLibraryObject _metadataLibrary =
        ...
        ///    current instance.
        /// </value>
        public ContentDescriptionObject ContentDescriptionObject => _description;
        ...
        public ExtendedContentDescriptionObject
            ExtendedContentDescriptionObject => _extDescription;
        ...
        /// </value>
        public override bool IsEmpty => _description.IsEmpty &&
        ...
        ///    instance.
        /// </value>
        public MetadataLibraryObject MetadataLibraryObject => _metadataLibrary;
        ...
        public override IPicture[] Pictures
        {
            get
            {
                ...
                foreach (DescriptionRecord record in
                    _metadataLibrary.GetRecords(0, 0,
                        "WM/Picture"))
                {
                    IPicture p = PictureFromData(
                        record.ToByteVector());
            ...
            set
            {
                if (value == null || value.Length == 0)
                {
                    ...
                    _metadataLibrary.RemoveRecords(0, 0,
                        "WM/Picture");
                    return;
                }
                ...
                if (bigPics)
                {
                    ...
                    RemoveDescriptors("WM/Picture");
                    _metadataLibrary.SetRecords(0, 0,
                        "WM/Picture", records);
                }
                else
                {
        ...
        /// </value>
        public override TagTypes TagTypes => TagTypes.Asf;
        ...
        public override void Clear()
        {
            ...
            _extDescription =
                new ExtendedContentDescriptionObject();
            _metadataLibrary.RemoveRecords(0, 0, "WM/Picture");
        }

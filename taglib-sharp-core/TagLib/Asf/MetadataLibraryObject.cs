...
namespace TagLib.Asf
{
        ...
        IEnumerable<DescriptionRecord>
    {
        ...
        /// </summary>
        private readonly List<DescriptionRecord> _records =
        ...
        public override ByteVector Render()
        {
            ...
            foreach (DescriptionRecord rec in _records)
            {
                count++;
                                   ...
                                   string name)
        {
            ...
            {
                DescriptionRecord rec = _records[i];
                                ...
                                params DescriptionRecord[] records)
        {
            ...
            _records.InsertRange(position, records);
        }

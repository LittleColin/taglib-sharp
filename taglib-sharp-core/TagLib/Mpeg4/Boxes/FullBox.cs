...
namespace TagLib.Mpeg4
{
    ...
    public abstract class FullBox : Box
    {
            ...
            : base(header, handler)
        {
            ...
            ByteVector headerData = file.ReadBlock(4);
            _version = headerData[0];
            _flags = headerData.Mid(1, 3).ToUInt();
        }
        ...
        {
            ByteVector output = new ByteVector(_version);
            output.Add(ByteVector.FromUInt(_flags).Mid(1, 3));
            output.Add(topData);

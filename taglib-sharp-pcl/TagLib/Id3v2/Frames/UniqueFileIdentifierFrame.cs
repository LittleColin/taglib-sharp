...
namespace TagLib.Id3v2
{
    ...
    public class UniqueFileIdentifierFrame : Frame
    {
        ...
        /// </summary>
        private ByteVector _identifier = null;
                                             ...
                                             byte version)
        {
            ...
            _owner = fields[0].ToString(StringType.Latin1);
            _identifier = fields[1];
        }
        ...
        protected override ByteVector RenderFields(byte version)
        {
            ...
            data.Add(ByteVector.FromString(_owner, StringType.Latin1));
            data.Add(ByteVector.TextDelimiter(StringType.Latin1));
            data.Add(_identifier);
        ...
        public override Frame Clone()
        {
            UniqueFileIdentifierFrame frame =
                new UniqueFileIdentifierFrame(_owner);
            if (_identifier != null)
                frame._identifier = new ByteVector(_identifier);
            return frame;
        }
    }
}
...
namespace TagLib.Id3v2
{
    ...
    public class UnsynchronisedLyricsFrame : Frame
    {
                                                              ...
                                                              string language)
        {
            ...
            int bestValue = -1;
            UnsynchronisedLyricsFrame bestFrame = null;
            ...
            foreach (Frame frame in tag.GetFrames(FrameType.Uslt))
            {
                ...
                bool sameName = uslt.Description == description;
                bool sameLang = uslt.Language == language;
        ...
        public override Frame Clone()
        {
            UnsynchronisedLyricsFrame frame =
                new UnsynchronisedLyricsFrame(_description,
                    _language, _encoding);
            frame._text = _text;
            return frame;
        }
                                             ...
                                             byte version)
        {
            ...
            string[] split = data.ToStrings(_encoding, 4, 2);

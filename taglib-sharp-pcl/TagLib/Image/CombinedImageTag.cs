...
namespace TagLib.Image
{
    ...
    {
        private List<ImageTag> _allTags = null;
        ...
        public List<ImageTag> AllTags
        {
            get
            {
                if (_allTags == null)
                {
                    _allTags = new List<ImageTag>();
                    if (Exif != null)
                        _allTags.Add(Exif);
                    _allTags.AddRange(OtherTags);
                }
        ...
        /// </summary>
        public List<ImageTag> OtherTags { get; }
        ...
        ///    the current instance.
        /// </summary>
        internal TagTypes AllowedTypes { get; }

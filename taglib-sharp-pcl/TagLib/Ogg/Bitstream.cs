...
namespace TagLib.Ogg
{
    ...
    public class Bitstream
    {
        ...
        /// </summary>
        private ByteVector _previousPacket;
        ...
        ///    page.
        /// </summary>
        private readonly long _firstAbsoluteGranularPosition;
        ...
        public Bitstream(Page page)
        {
            ...
            _firstAbsoluteGranularPosition =
        ...
        public bool ReadPage(Page page)
        {
            ...
            for (int i = 0; i < packets.Length; i++)
            {
                ...
                if (i == 0 && (page.Header.Flags &
                    ...
                    _previousPacket != null)
                {
                    _previousPacket.Add(packet);
                    packet = _previousPacket;
                }
                ...
                if (i == packets.Length - 1)
                {
                    ...
                    // page, store it.
                    _previousPacket = new ByteVector(packet);
                }
        ...
        {
            return _codec.ReadPacket(packet, _packetIndex++);
        }
    }
}
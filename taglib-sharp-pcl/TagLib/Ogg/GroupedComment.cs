...
namespace TagLib.Ogg
{
    ...
    public class GroupedComment : Tag
    {
        ...
        ///    comments.
        /// </summary>
        private readonly Dictionary<uint, XiphComment> _commentHash;

        /// <summary>
        ///    Contains comments in the order they are added.
        /// </summary>
        private readonly List<XiphComment> _tags;
        ...
        {
            _commentHash = new Dictionary<uint, XiphComment>();
            _tags = new List<XiphComment>();
        }
        ...
        /// </value>
        public IEnumerable<XiphComment> Comments => _tags;
        ...
        {
            return _commentHash[streamSerialNumber];
        }
        ...
        public void AddComment(uint streamSerialNumber,
                                XiphComment comment)
        {
            _commentHash.Add(streamSerialNumber, comment);
            _tags.Add(comment);
        }
        ...
        public override TagTypes TagTypes
        {
            get
            {
                ...
                foreach (XiphComment tag in _tags)
                    if (tag != null)
                        types |= tag.TagTypes;
        ...
        public override string Title
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Title = value; }
        }
        ...
        public override string TitleSort
        {
            ...
            set { if (_tags.Count > 0) _tags[0].TitleSort = value; }
        }
        ...
        public override string[] Performers
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Performers = value; }
        }
        ...
        public override string[] PerformersSort
        {
            ...
            set { if (_tags.Count > 0) _tags[0].PerformersSort = value; }
        }
        ...
        public override string[] AlbumArtists
        {
            ...
            set { if (_tags.Count > 0) _tags[0].AlbumArtists = value; }
        }
        ...
        public override string[] AlbumArtistsSort
        {
            ...
            set { if (_tags.Count > 0) _tags[0].AlbumArtistsSort = value; }
        }
        ...
        public override string[] Composers
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Composers = value; }
        }
        ...
        public override string[] ComposersSort
        {
            ...
            set { if (_tags.Count > 0) _tags[0].ComposersSort = value; }
        }
        ...
        public override string Album
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Album = value; }
        }
        ...
        public override string AlbumSort
        {
            ...
            set { if (_tags.Count > 0) _tags[0].AlbumSort = value; }
        }
        ...
        public override string Comment
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Comment = value; }
        }
        ...
        public override string[] Genres
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Genres = value; }
        }
        ...
        public override uint Year
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Year = value; }
        }
        ...
        public override uint Track
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Track = value; }
        }
        ...
        public override uint TrackCount
        {
            ...
            set { if (_tags.Count > 0) _tags[0].TrackCount = value; }
        }
        ...
        public override uint Disc
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Disc = value; }
        }
        ...
        public override uint DiscCount
        {
            ...
            set { if (_tags.Count > 0) _tags[0].DiscCount = value; }
        }
        ...
        public override string Lyrics
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Lyrics = value; }
        }
        ...
        public override string Grouping
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Grouping = value; }
        }
        ...
        public override uint BeatsPerMinute
        {
            ...
            set { if (_tags.Count > 0) _tags[0].BeatsPerMinute = value; }
        }
        ...
        public override string Conductor
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Conductor = value; }
        }
        ...
        public override string Copyright
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Copyright = value; }
        }
        ...
        public override string MusicBrainzArtistId
        {
            ...
            set { if (_tags.Count > 0) _tags[0].MusicBrainzArtistId = value; }
        }
        ...
        public override string MusicBrainzReleaseId
        {
            ...
            set { if (_tags.Count > 0) _tags[0].MusicBrainzReleaseId = value; }
        }
        ...
        public override string MusicBrainzReleaseArtistId
        {
            ...
            set { if (_tags.Count > 0) _tags[0].MusicBrainzReleaseArtistId = value; }
        }
        ...
        public override string MusicBrainzTrackId
        {
            ...
            set { if (_tags.Count > 0) _tags[0].MusicBrainzTrackId = value; }
        }
        ...
        public override string MusicBrainzDiscId
        {
            ...
            set { if (_tags.Count > 0) _tags[0].MusicBrainzDiscId = value; }
        }
        ...
        public override string MusicIpId
        {
            ...
            set { if (_tags.Count > 0) _tags[0].MusicIpId = value; }
        }
        ...
        public override string AmazonId
        {
            ...
            set { if (_tags.Count > 0) _tags[0].AmazonId = value; }
        }
        ...
        public override string MusicBrainzReleaseStatus
        {
            ...
            set { if (_tags.Count > 0) _tags[0].MusicBrainzReleaseStatus = value; }
        }
        ...
        public override string MusicBrainzReleaseType
        {
            ...
            set { if (_tags.Count > 0) _tags[0].MusicBrainzReleaseType = value; }
        }
        ...
        public override string MusicBrainzReleaseCountry
        {
            ...
            set { if (_tags.Count > 0) _tags[0].MusicBrainzReleaseCountry = value; }
        }
        ...
        public override IPicture[] Pictures
        {
            ...
            set { if (_tags.Count > 0) _tags[0].Pictures = value; }
        }

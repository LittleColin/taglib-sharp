...
namespace TagLib.IFD.Entries
{
    ...
    public class MakernoteIfdEntry : IFdEntry
    {
        ...
        /// </value>
        private readonly ByteVector _prefix;
        ...
        /// </value>
        private readonly bool _absoluteOffset;
        ...
        ///    surrounding IFD is used.
        /// </param>
        public MakernoteIfdEntry(ushort tag, IfdStructure structure, MakernoteType makernoteType, ByteVector prefix, uint ifdOffset, bool absoluteOffset, bool? isBigendian)
        {
            Tag = tag;
            Structure = structure;
        ...
        ///    A <see cref="MakernoteType"/> with the type of the makernote.
        /// </param>
        public MakernoteIfdEntry(ushort tag, IfdStructure structure, MakernoteType makernoteType)
            : this(tag, structure, makernoteType, null, 0, true, null) { }
        ...
        public ByteVector Render(bool isBigendian, uint offset, out ushort type, out uint count)
        {
            ...
            var renderer =
                new IfdRenderer(_isBigendian ?? isBigendian, Structure, _absoluteOffset ? offset + _ifdOffset : _ifdOffset);

            ByteVector data = renderer.Render();
            data.Insert(0, _prefix);

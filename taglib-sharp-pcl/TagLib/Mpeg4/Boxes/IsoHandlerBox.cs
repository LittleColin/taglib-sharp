...
namespace TagLib.Mpeg4
{
    ...
    public class IsoHandlerBox : FullBox
    {
        ...
        /// </summary>
        private readonly ByteVector _handlerType;
            ...
            : base(header, file, handler)
        {
            ...
            ByteVector boxData = file.ReadBlock(DataSize - 4);
            _handlerType = boxData.Mid(0, 4);

            int end = boxData.Find((byte)0, 16);
            if (end < 16)
                end = boxData.Count;
            _name = boxData.ToString(StringType.Utf8, 16, end - 16);
        }
            ...
            : base("hdlr", 0, 0)
        {
            ...
            _handlerType = handlerType.Mid(0, 4);
            _name = name;
        }
        ...
        public override ByteVector Data
        {
            get
            {
                ...
                output.Add(_handlerType);
                output.Add(new ByteVector(12));
                output.Add(ByteVector.FromString(_name,
                    StringType.Utf8));
        ...
        /// </value>
        public ByteVector HandlerType => _handlerType;

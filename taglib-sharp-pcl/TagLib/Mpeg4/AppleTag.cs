...
namespace TagLib.Mpeg4
{
    ...
    public class AppleTag : Tag, IEnumerable<Box>
    {
        ...
        ///    stored.
        /// </summary>
        private readonly IsoMetaBox _metaBox;

        /// <summary>
        ///    Contains the ILST box which holds all the values.
        /// </summary>
        private readonly AppleItemListBox _ilstBox;
        ...
        public AppleTag(IsoUserDataBox box)
        {
            ...
            _metaBox = box.GetChild(BoxType.Meta) as IsoMetaBox;
            if (_metaBox == null)
            {
                _metaBox = new IsoMetaBox("mdir", null);
                box.AddChild(_metaBox);
            }

            _ilstBox = _metaBox.GetChild(BoxType.Ilst)
                as AppleItemListBox;

            if (_ilstBox == null)
            {
                _ilstBox = new AppleItemListBox();
                _metaBox.AddChild(_ilstBox);
            }
        }
        ...
        public IEnumerable<AppleDataBox> DataBoxes(IEnumerable<ByteVector> types)
        {
            ...
            foreach (Box box in _ilstBox.Children)
        ...
        public void SetText(ByteVector type, string[] text)
        {
            ...
            if (text == null)
            {
                _ilstBox.RemoveChild(FixId(type));
                return;
            }
        ...
        {
            return _ilstBox.Children.GetEnumerator();
        }
        ...
        /// </value>
        public override bool IsEmpty => !_ilstBox.HasChildren;

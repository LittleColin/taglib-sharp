...
namespace TagLib.Flac
{
    ...
    public struct StreamHeader : IAudioCodec, ILosslessAudioCodec
    {
        ...
        /// </summary>
        private readonly uint _lowLength;
        ...
        public StreamHeader(ByteVector data, long streamLength)
        {
            ...
            _flags = data.Mid(10, 4).ToUInt(true);
            _lowLength = data.Mid(14, 4).ToUInt(true);
        }
        ...
        /// </value>
        public TimeSpan Duration => (AudioSampleRate > 0 && _streamLength > 0)
        ...
        /// </value>
        public int AudioSampleRate => (int)(_flags >> 12);
        ...
        ///    instance.
        /// </value>
        public int AudioChannels => (int)(((_flags >> 9) & 7) + 1);
        ...
        ///    instance.
        /// </value>
        public int BitsPerSample => (int)(((_flags >> 4) & 31) + 1);

...
namespace TagLib.Flac
{
    ...
    public struct BlockHeader
    {
        ...
        /// </summary>
        private readonly bool _isLastBlock;
        ...
        public BlockHeader(ByteVector data)
        {
            ...
            _blockType = (BlockType)(data[0] & 0x7f);
            _isLastBlock = (data[0] & 0x80) != 0;
            _blockSize = data.Mid(1, 3).ToUInt();
        }
        ...
        {
            ByteVector data = ByteVector.FromUInt(_blockSize);
            data[0] = (byte)(_blockType + (isLastBlock ? 0x80 : 0));
            return data;
        }
        ...
        /// </value>
        public bool IsLastBlock => _isLastBlock;

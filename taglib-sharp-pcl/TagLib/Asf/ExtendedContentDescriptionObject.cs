...
namespace TagLib.Asf
{
        ...
        IEnumerable<ContentDescriptor>
    {
        ...
        /// </summary>
        private readonly List<ContentDescriptor> _descriptors =
        ...
        public override ByteVector Render()
        {
            ...
            foreach (ContentDescriptor desc in _descriptors)
            {
                count++;
                                    ...
                                    params ContentDescriptor[] descriptors)
        {
            ...
            int position = _descriptors.Count;
            for (int i = _descriptors.Count - 1; i >= 0; i--)
            {
                if (name == _descriptors[i].Name)
                {
            ...
            _descriptors.InsertRange(position, descriptors);
        }

...
namespace TagLib.Aac
{
    ...
    public class AudioHeader : IAudioCodec
    {
        ...
        /// </summary>
        private static readonly int[] SampleRates = new int[13] {
        ...
        /// </value>
        public int AudioBitrate => _audiobitrate;
        ...
        public void SetStreamLength(long streamLength)
        {
            ...
            _duration = TimeSpan.FromSeconds(_streamLength * 8.0 / _audiobitrate);
        }
                    ...
                    if (buffer[i] == 0xFF
                        ...
                        try
                        {
                            ...
                            if (samplerateindex >= SampleRates.Length)
                                return false;
                            long samplerate = SampleRates[samplerateindex];
